...
- [ ] **URGENT** update the way of handling valid user options field to have only 1 field and it's counter so you always update the option on the fly and add extra ones
